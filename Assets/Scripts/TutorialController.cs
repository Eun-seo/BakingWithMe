...
public class TutorialController : MonoBehaviour
{
    ...
    IEnumerator GetStart()
    {
        ...
        //yield return new WaitForSeconds(1);
        //noticeBtn[2].GetComponent<TextMesh>().text = "5";
        //yield return new WaitForSeconds(1);
        //noticeBtn[2].GetComponent<TextMesh>().text = "4";
        //yield return new WaitForSeconds(1);
        //noticeBtn[2].GetComponent<TextMesh>().text = "3";
        //yield return new WaitForSeconds(1);
        //noticeBtn[2].GetComponent<TextMesh>().text = "2";
        //yield return new WaitForSeconds(1);
        //noticeBtn[2].GetComponent<TextMesh>().text = "1";
        yield return new WaitForSeconds(1);
        Debug.Log("getStart()");
        ToNext();
    }
